...
<head>
    ...
    @yield('header', view(CarRentalsHelper::viewPath('vendor-dashboard.layouts.header')))
    ...
    <script type="text/javascript">
        'use strict';
        window.trans = Object.assign(window.trans || {}, JSON.parse('{!! addslashes(json_encode(trans('plugins/car-rentals::car-rentals'))) !!}'));
        ...
        BotbleVariables.languages = {
            ...
            system: {
                character_remain: '{{ trans('plugins/car-rentals::vendor-dashboard.character_remain') }}'
            }
        };

        var RV_MEDIA_URL = {
            'media_upload_from_editor': '{{ route('car-rentals.vendor.upload-from-editor') }}'
        };
...
@yield('body', view(CarRentalsHelper::viewPath('vendor-dashboard.layouts.body')))
...
{!! Assets::renderFooter() !!}
@yield('footer', view(CarRentalsHelper::viewPath('vendor-dashboard.layouts.footer')))
