...
mix
    ...
    .js(`${source}/resources/js/car-availability-calendar.js`, `${dist}/js`)
    .js(`${source}/resources/js/currencies.js`, `${dist}/js`)
    .js(`${source}/resources/js/customer-view.js`, `${dist}/js`)
    .js(`${source}/resources/js/vendor-view.js`, `${dist}/js`)
...
if (mix.inProduction()) {
    mix
        ...
        .copy(`${dist}/js/car-availability-calendar.js`, `${source}/public/js`)
        .copy(`${dist}/js/currencies.js`, `${source}/public/js`)
        .copy(`${dist}/js/customer-view.js`, `${source}/public/js`)
        .copy(`${dist}/js/vendor-view.js`, `${source}/public/js`)
}
